...
export default function About({ currentIndex }) {
  return (
    <div className="relative w-screen h-screen">
      ...
      <div className="grid grid-cols-1 sm:w-6/12 w-full h-screen content-center">
        <div className="pl-5">
        ...
        <div className="px-9 pt-5 text-white sm:text-base text-sm">My name is Jóhann, I'm a recent graduate of the University of Reykjavík in Iceland. I'm excited to work on challenging real world projects.</div>
        <div className="px-9 text-white">I feel comfortable in any computer language but I am also fluent in Icelandic, English and Japanese.</div>
      </div>
    </div>
  );
}
